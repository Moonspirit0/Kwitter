var firebaseConfig = {
  ...
  appId: "1:750096594832: web: 4 d91b67f01f9abc1a4a515 "
};
// Initialize Firebase
    ...
    firebase.database().ref("/" + room_name).on('value', function (snapshot) {
        ...
        snapshot.forEach(function (childSnapshot) {
            ...
            if (childKey != "purpose") {
                ...
                name_with_tag = "<h4> " + name + < img class = 'user_tick'
                src = 'tick.png' > < /h4>";
                like_button = "<button class='btn btn-warning' id=" + firebase_messge_id + " value=" + like + " onlick='updateLike(this.id)'>";
